...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		//if player is grounded,reset double jump to true
		if(isGrounded){
		...
		else if(_canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) //if it can double jump and jump button pressed,do jump
			{
				DoJump();
